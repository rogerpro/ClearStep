...
class InvoicesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'rendered' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '0', 'comment' => 'File generated', 'precision' => null],
        'transaction_id' => ['type' => 'uuid', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'created' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => 'Invoice date', 'precision' => null],
        'modified' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_indexes' => [
            'year' => ['type' => 'index', 'columns' => ['year'], 'length' => []],
            'number' => ['type' => 'index', 'columns' => ['number'], 'length' => []],
            'amount' => ['type' => 'index', 'columns' => ['amount'], 'length' => []],
            ...
            'rendered' => ['type' => 'index', 'columns' => ['rendered'], 'length' => []],
            'transaction_id' => ['type' => 'index', 'columns' => ['transaction_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'year_number' => ['type' => 'unique', 'columns' => ['year', 'number'], 'length' => []],
            'invoices_ibfk_1' => ['type' => 'foreign', 'columns' => ['ticket_id'], 'references' => ['tickets', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'invoices_ibfk_2' => ['type' => 'foreign', 'columns' => ['transaction_id'], 'references' => ['transactions', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'invoices_ibfk_3' => ['type' => 'foreign', 'columns' => ['currency_id'], 'references' => ['currencies', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',

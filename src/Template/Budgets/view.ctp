...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(__('Delete Budget'), ['action' => 'delete', $budget->id],
...
<div class="budgets view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $budget->has('currency') ? $this->Html->link($budget->currency->name,
                    ['controller' => 'Currencies', 'action' => 'view', $budget->currency->id]) : '' ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Invoice') ?></th>
            <td><?= $budget->has('invoice') ? $this->Html->link($budget->invoice->title,
                    ['controller' => 'Invoices', 'action' => 'view', $budget->invoice->id]) : '' ?></td>
        </tr>
        <tr>

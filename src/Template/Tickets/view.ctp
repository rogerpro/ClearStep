...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(__('Delete Ticket'), ['action' => 'delete', $ticket->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $ticket->id)]) ?> </li>
...
<div class="tickets view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $ticket->has('project') ? $this->Html->link($ticket->project->name,
                    ['controller' => 'Projects', 'action' => 'view', $ticket->project->id]) : '' ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Session') ?></th>
            <td><?= $ticket->has('session') ? $this->Html->link($ticket->session->id,
                    ['controller' => 'Sessions', 'action' => 'view', $ticket->session->id]) : '' ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?= $ticket->has('state') ? $this->Html->link($ticket->state->name,
                    ['controller' => 'States', 'action' => 'view', $ticket->state->id]) : '' ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Budget') ?></th>
            <td><?= $ticket->has('budget') ? $this->Html->link($ticket->budget->title,
                    ['controller' => 'Budgets', 'action' => 'view', $ticket->budget->id]) : '' ?></td>
        </tr>
        <tr>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <?= $this->Html->link(__('View'),
                                ['controller' => 'Invoices', 'action' => 'view', $invoices->id]) ?>
                            <?= $this->Html->link(__('Edit'),
                                ['controller' => 'Invoices', 'action' => 'edit', $invoices->id]) ?>
                            <?= $this->Form->postLink(__('Delete'),
                                ['controller' => 'Invoices', 'action' => 'delete', $invoices->id],
                                ['confirm' => __('Are you sure you want to delete # {0}?', $invoices->id)]) ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </table>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <?php foreach ($ticket->comments as $comments): ?>
                    <tr>
                        ...
                        <td class="actions">
                            <?= $this->Html->link(__('View'),
                                ['controller' => 'Comments', 'action' => 'view', $comments->id]) ?>
                            <?= $this->Html->link(__('Edit'),
                                ['controller' => 'Comments', 'action' => 'edit', $comments->id]) ?>
                            <?= $this->Form->postLink(__('Delete'),
                                ['controller' => 'Comments', 'action' => 'delete', $comments->id],

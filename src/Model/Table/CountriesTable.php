...
class CountriesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->notEmpty('spa')
            ->add('spa', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);

        $validator
            ->requirePresence('cat', 'create')
            ->notEmpty('cat')
            ->add('cat', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
    ...
    {
        $rules->add($rules->isUnique(['spa']));
        $rules->add($rules->isUnique(['cat']));
